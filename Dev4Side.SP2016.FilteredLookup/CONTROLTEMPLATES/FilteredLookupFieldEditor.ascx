<%@ Control Language="C#" AutoEventWireup="false" CompilationMode="Always" Inherits="Dev4Side.SPSE.FilteredLookup.FilteredLookupFieldEditor, Dev4Side.SPSE.FilteredLookup, Version=1.0.0.0, Culture=neutral, PublicKeyToken=af31a3eeecf7add1" %>
